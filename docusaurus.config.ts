...
const config: Config = {
  title: 'AI-Driven Book Using Docusaurus',
  tagline: 'Build structured books as websites with AI and Docusaurus',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} GIAIC_Quatar_04. Built with Docusaurus.`,
    },
    prism: {
  ...
  customFields: {
    backendUrl: process.env.BACKEND_URL || 'http://localhost:8000/query',
  }
};
