...
- **Modified principles**: 
  - Accuracy: Now includes "real-world examples"
  - Clarity: Targeted to "developers familiar with AI tools"
  - Reproducibility: "specs traceable to Spec-Kit Plus artifacts"
...
-->
# AI/Spec-Driven Book Creation using Gemini CLI and Spec-Kit Plus Constitution
...
### III. Reproducibility
All code snippets executable, specs traceable to Spec-Kit Plus artifacts.

### IV. Rigor
Open-source tools preferred, with citations to GitHub repos.
